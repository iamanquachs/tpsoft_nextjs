    ...
    <>
      <div className="section_home">
          ...
          <Container>
            <Row>
              <Col sm={4} className="section_product_detail_left">
                <Image
                  width={200}
                  src={require("../vendor/image/Logo_EGpp.svg")}
                  alt={"PHẦN MỀM QUẢN LÝ NHÀ THUỐC GPP"}
                />
                <h3>Quản lý Nhà thuốc GPP</h3>
              </Col>
              <Col sm={8} className="section_product_detail_right">
                <p>
                  Phần mềm quản lý nhà thuốc (egpp) cung cấp một giải pháp toàn
                  diện cho việc quản lý và vận hành nhà thuốc một cách hiệu quả.
                  Nó tự động hóa các quy trình từ quản lý kho hàng, bán hàng,
                  đến chăm sóc khách hàng, giúp tiết kiệm thời gian và giảm
                  thiểu sai sót.
                </p>
                <p>
                  Tính năng quản lý hàng tồn kho, phần mềm cho phép theo dõi
                  chính xác lượng hàng hóa, kiểm soát hạn sử dụng sản phẩm, đồng
                  thời tự động cập nhật dữ liệu bán hàng vào hệ thống. Tính năng
                  quản lý bán hàng và thu ngân đảm bảo quá trình thanh toán diễn
                  ra suôn sẻ, nhanh chóng, cải thiện trải nghiệm mua sắm cho
                  khách hàng
                </p>
                <p>
            ...
            <Row>
              <Col xs={12}>
                <div className="section_sanpham_item row">
                  <Col sm={6} xs={12}>
                    <div className="style_image_ctsanpham ep3"></div>
                  </Col>
                  <Col sm={6} xs={12}>
                    {/* <!-- EC Left --> */}
                  ...
                  <Col sm={6} xs={12}>
                    ...
                    <div className="ec_item">
                      <ul>
                        ...
                        <li>
                          <p>
                            Quản lý và kiểm soát hoạt động kinh doanh của cơ sở,
                            tránh mất kiểm soát, thất thoát hàng hóa; Kiểm soát
                            thu chi hàng ngày; Quản trị và phân quyền nhân viên
                            linh hoạt, chặt chẽ.
                          </p>
                        </li>
                        ...
                        <li>
                          <p>
                            ...
                            hàng hóa bán có doanh số cao, hàng hóa bán theo đơn.
                          </p>
                        </li>
                      </ul>
                    </div>
                  ...
                  <Col sm={6} xs={12}>
                    ...
                    <div className="ec_item">
                      <ul>
                        ...
                        <li>
                          <p>
                            Tạo phiếu bán thuốc mẫu cho từng loại bệnh cụ thể;
                            Quản lý thuốc bán theo đơn, thuốc quản lý đặc biệt;
                            Cấp quyền cho nhân viên được bán loại thuốc nào.
                          </p>
                        </li>
        ...
        <div className="section_home_contact bg_product_tuvan">
          <h2 style={{ color: "#014e1a" }}>Đăng ký dùng thử</h2>
          <div className="section_home_div">
            ...
            <div className="flex_contact">
              ...
              <button
                style={{ backgroundColor: "#014e1a", color: "white" }}
                onClick={(e) => {
                  sendEmail();
                }}
                type="button"
