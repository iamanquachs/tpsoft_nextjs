            ...
            <Row>
              <Col sm={4} className="section_product_detail_left">
                <Image
                  ...
                  alt={"PHẦN MỀM QUẢN LÝ NHA KHOA"}
                />
                <h3>Quản lý Nha Khoa</h3>
              </Col>
              <Col sm={8} className="section_product_detail_right">
                <p>
                  Phần mềm Quản lý Nha khoa (onebis) cung cấp một giải pháp toàn
                  diện cho các cơ sở Nha khoa, giúp tối ưu hóa quy trình làm
                  ...
                  nha khoa từ lịch hẹn, quản lý khách hàng, đến hồ sơ điều trị
                ...
                <p>
                  ...
                  suất của bác sĩ và nhân viên y tế trong việc theo dõi quá
            ...
            <Row>
              <Col xs={12}>
                <div className="section_sanpham_item row">
                  <Col sm={6} xs={12}>
                    <div className="style_image_ctsanpham nk1"></div>
                  </Col>
                  <Col sm={6} xs={12}>
                    {/* <!-- EC Left --> */}
              ...
              <Col xs={12}>
                <div className="section_sanpham_item row">
                  <Col sm={6} xs={12}>
                    <div className="style_image_ctsanpham nk2"></div>
                  </Col>
                  <Col sm={6} xs={12}>
                    {/* <!-- EC Right --> */}
                    <div className="ec_item">
