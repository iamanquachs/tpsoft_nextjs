...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _axiosClient_not_token__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5038);
...
const mailAPI = {
    send_mail: (params)=>{
        ...
        return _axiosClient_not_token__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, params);
    }
};
