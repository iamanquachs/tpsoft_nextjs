            ...
            <Row>
              <Col sm={4} className="section_product_detail_left">
                <Image
                  ...
                  alt={"PHẦN MỀM QUẢN LÝ THẨM MỸ VIỆN"}
                />
                <h3>Quản lý Thẩm Mỹ Viện</h3>
              </Col>
              <Col sm={8} className="section_product_detail_right">
                <p>
                  Phần mềm Quản lý Thẩm Mỹ Viện (onebis) cung cấp một giải pháp
                  toàn diện cho các Thẩm Mỹ Viện, giúp tối ưu hóa quy trình làm
                  việc và nâng cao chất lượng dịch vụ. Với công nghệ tiên tiến,
                  phần mềm này giúp quản lý hiệu quả mọi khía cạnh của hoạt động
                  Thẩm Mỹ Viện từ lịch hẹn, quản lý khách hàng, đến hồ sơ điều
                  trị và hoạt động kinh doanh.
                </p>
                <p>
                  Tính năng quản lý khách hàng cho phép lưu trữ và truy cập dễ
                  dàng thông tin chi tiết của khách hàng, bao gồm lịch sử dịch
                  vụ và thông tin liên lạc. Tính năng này cải thiện đáng kể hiệu
                  suất của chuyên gia và nhân viên trong việc theo dõi quá trình
            ...
            <Row>
              <Col xs={12}>
                <div className="section_sanpham_item row">
                  <Col sm={6} xs={12}>
                    <div className="style_image_ctsanpham tm1"></div>
                  </Col>
                  <Col sm={6} xs={12}>
                    {/* <!-- EC Left --> */}
              ...
              <Col xs={12}>
                <div className="section_sanpham_item row">
                  <Col sm={6} xs={12}>
                    <div className="style_image_ctsanpham tm2"></div>
                  </Col>
                  <Col sm={6} xs={12}>
                    {/* <!-- EC Right --> */}
                    <div className="ec_item">
                      <ul>
                        <li>
                          <p>
                            Lưu trữ an toàn và quản lý hiệu quả thông tin khách
                            hàng, quá trình điều trị, lịch sử sử dụng, đánh giá
                            trải nghiệm khách hàng.
                          </p>
                        </li>
                        <li>
                          <p>
                            Tự động hóa việc đặt và quản lý lịch hẹn, giảm thiểu
                            thời gian chờ đợi cho khách hàng và tối ưu hóa lịch
                            trình làm việc của chuyên gia.
                          </p>
                        </li>
                        <li>
                          <p>
                            Tự động hóa các quy trình làm việc giúp tối ưu hóa
                            hiệu suất làm việc, giảm thiểu sai sót.
                          </p>
                        </li>
                        <li>
                          <p>
                            Báo cáo chuyên sâu về hiệu quả kinh doanh, chi phí,
                            và phân khúc khách hàng, hỗ trợ quyết định kinh
                ...
                <div className="section_sanpham_item row">
                  ...
                  <Col sm={6} xs={12}>
                    ...
                    <div className="ec_item">
                      <ul>
                        <li>
                          <p>Theo dõi công nợ phải thu, phải trả chính xác</p>
                        </li>
                        <li>
                          <p>
                        ...
                        <li>
                          <p>
                            Theo dõi chính xác hàng tồn kho, bao gồm việc nhập,
                            xuất hàng và kiểm soát hạn sử dụng của sản phẩm
                          </p>
                        </li>
                        <li>
                          <p>
                            Xây dựng các chương trình khuyến mãi, Voucher, phân
                            khúc khách hàng theo thành viên, độ tuổi
                          </p>
                        </li>
                        <li>
                          <p>
                            Linh hoạt xây dựng gói dịch vụ, liệu trình nhằm thu
                            hút khách hàng sử dụng
                          </p>
                        </li>
                        <li>
                          <p>
                            Báo cáo tự động hiệu quả làm việc của nhân viên,
                            trải nghiệm khách hàng, hàng hóa có doanh số cao,
                            chưa cao
                          </p>
                        </li>
                        <li>
                          <p>Tính lương nhân viên theo hiệu quả làm việc</p>
                        </li>
                      </ul>
                    </div>
                  </Col>
