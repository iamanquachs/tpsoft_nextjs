          ...
          <Container>
            <Row>
              ...
              <Col sm={8} className="section_product_detail_right">
                <p>
                  Phần mềm Quản lý Spa & Nail (onebis) cung cấp một giải pháp
                  toàn diện cho các cơ sở làm đẹp, giúp tối ưu hóa quy trình làm
                  ...
                  Spa & Nail từ lịch hẹn, quản lý khách hàng, đến nhân viên và
                      ...
                      <ul>
                        <li>
                          <p>
                            ...
                            hàng, quá trình sử dụng dịch vụ, lịch sử sử dụng,
